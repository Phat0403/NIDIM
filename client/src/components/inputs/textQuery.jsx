...
const TextQuery = ()=>{
    ...
    return (
        <div>
            ...
            <button  className="mt-11 w-12 h-12 bg-blue-500 text-white rounded-full flex items-center justify-center hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"><CiSearch/></button>
            </span>
            <h1>{valueQuery}</h1>
        </div>
    )
