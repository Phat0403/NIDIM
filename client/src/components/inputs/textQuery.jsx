...
const TextQuery = (props)=>{
    ...
    return (
        <div>
            ...
            <span className="flex  ">
            <textarea onChange={(e)=>{setValueQuery(e.target.value)}} id="message" rows="4" className="mr-10 block p-2.5 w-[300px] text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
