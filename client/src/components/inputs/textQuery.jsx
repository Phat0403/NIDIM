...
const TextQuery = (props)=>{
    ...
    return (
        <div className="w-80 flex flex-col items-center justify-center bg-gray-50 p-4 rounded-lg shadow-lg mt-2 ">
            ...
            <button onClick={handleClickBtn} className="mt-2 w-full rounded-lg h-10 bg-blue-500 text-white  items-center justify-center hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">Search</button>
        </div>
    )
}
